              ...
              BoxDecoration(color: Colors.white, borderRadius: radiusAll20),
                child: Column(
                  children: [
                    ...
                    Padding(
                        padding: EdgeInsetsDirectional.only(top: SizeConfig().h(0), bottom: SizeConfig().h(20)),
                        child: CustomButton(
                        ...
                        InkWell(
                          onTap: () {
                            Navigator.pushNamed(context, ResetPassword_PhoneNumberPage.route);
                          },
                        child: Padding(child:
                        Text(translate("labels.forgotPassword"), style: TextStyle(fontWeight: FontWeight.bold))
                          ,padding: EdgeInsetsDirectional.only(bottom: SizeConfig().h(20)),)
                        )
