...
class _ApiClient implements ApiClient {
  ...
  Future<StationsWithPagination> getFrequentlyVisitedStations(token) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'Company/FrequentlyVisitedCompanies',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<StationBranchesWithPagination> getFrequentlyVisitedStationsBranches(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<StationBranchesWithPagination>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'Company/FrequentlyVisitedCompaniesBranches',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<StationBranchesWithPagination> getFavoritesStationsBranches(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'Company/FavoriteCompaniesBranches',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<StationBranchesWithPagination> getStationBranchByText(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'Company/CompaniesBranchesByText/${text}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<bool> addStationToFavorite(
    token,
    addRemoveStationFavoriteBody,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  Future<bool> addStationBranchToFavorite(
    token,
    addRemoveStationBranchFavoriteBody,
  ) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
  ...
  Future<bool> removeStationBranchFromFavorite(
    ...
    final _result = await _dio.fetch<bool>(_setStreamType<bool>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'Company/RemoveBranchFromFavorite',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<StationsWithPagination> getAllStations(
    token,
    page,
    pageSize,
  ) async {
  ...
  Future<PaymentTransactionsWithPagination> getPaymentTransactions(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PaymentTransactionsWithPagination>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SyberPayGetUrlResponseBody> syberPayGetUrl(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SyberPayGetUrlResponseBody>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<bool> editBankCard(
    ...
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(editBankCardBody.toJson());
    final _result = await _dio.fetch<bool>(_setStreamType<bool>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  @override
  Future<BankCardsWithPagination> getBankCards(
    token,
    page,
    pageSize,
  ) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<BankCardsWithPagination>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<bool> addUserRefillTransaction(
    token,
  ...
  @override
  Future<bool> removeAccount(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
  ...
  @override
  Future<double> getFastfillFees(token) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
